...
- Flat design verification passed: theme toggle, contact CTA, Koda card, repository panel, CV pill, social links, repository rows, and tooltip resolve to `box-shadow: none`, `filter: none`, and `backdrop-filter: none`.
